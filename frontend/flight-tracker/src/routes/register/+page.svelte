...
<main
    class="grid grid-cols-1 md:grid-cols-2 gap-4 md:grid-cols-2 md:gap-8 h-screen items-center justify-center p-6 md:p-0"
>
    <div
    ...
    >
        <div class="text-center">
            ...
            <p class="text-lg">
                Create your account to track flights and manage your trips
                effortlessly.
            </p>
        </div>
    </div>
